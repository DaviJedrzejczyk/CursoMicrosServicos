...
namespace GeekShopping.IdentityServer.Initialazer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            _user.CreateAsync(admin, "Davi2603$").GetAwaiter().GetResult();
            ...
            ApplicationUser client = new ApplicationUser()
            {
                ...
                Email = "davi-client@erudio.com.br",
                EmailConfirmed = true,
                PhoneNumber = "+55 (34) 12345-6789",
                FirstName = "Davi",
                LastName = "Client"
            ...
            _user.CreateAsync(client, "Davi2603$").GetAwaiter().GetResult();
